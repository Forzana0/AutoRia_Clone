...
{
    /// <inheritdoc />
    public partial class AllCarEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_body_types", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_car_brands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_engine_volumes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_fuel_types", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "tbl_numbers_of_seats",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_numbers_of_seats", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "tbl_transmisions_types",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_transmisions_types", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "tbl_transport_types",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_transport_types", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_car_models", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tbl_car_models_tbl_car_brands_CarBrandId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransportTypeId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    NumberOfSeatsId = table.Column<int>(type: "integer", nullable: true),
                    FuelTypesId = table.Column<int>(type: "integer", nullable: true),
                    EngineVolumeId = table.Column<int>(type: "integer", nullable: true),
                    CityId = table.Column<int>(type: "integer", nullable: true),
                    Price = table.Column<decimal>(type: "numeric", nullable: false),
                    ColorId = table.Column<int>(type: "integer", nullable: true),
                    Metallic = table.Column<bool>(type: "boolean", nullable: false),
                    AccidentParticipation = table.Column<bool>(type: "boolean", nullable: false),
                    HasPowerWindows = table.Column<bool>(type: "boolean", nullable: false),
                    HasAirConditioning = table.Column<bool>(type: "boolean", nullable: false),
                    HasLeatherInterior = table.Column<bool>(type: "boolean", nullable: false),
                    HasPremiumInteriorColor = table.Column<bool>(type: "boolean", nullable: false),
                    HasPowerSteering = table.Column<bool>(type: "boolean", nullable: false),
                    HasHeightAdjustableSeats = table.Column<bool>(type: "boolean", nullable: false),
                    HasHeadlights = table.Column<bool>(type: "boolean", nullable: false),
                    HasSpareWheel = table.Column<bool>(type: "boolean", nullable: false),
                    HasSeatMemory = table.Column<bool>(type: "boolean", nullable: false),
                    HasHeatedSeats = table.Column<bool>(type: "boolean", nullable: false),
                    HasSeatVentilation = table.Column<bool>(type: "boolean", nullable: false),
                    IsNotCustomsCleared = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    IsInstallmentAvailable = table.Column<bool>(type: "boolean", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_cars_tblCities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_car_photos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tbl_car_photos_tbl_cars_CarId",
                        column: x => x.CarId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_car_models_CarBrandId",
                table: "tbl_car_models",
                column: "CarBrandId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_car_photos_CarId",
