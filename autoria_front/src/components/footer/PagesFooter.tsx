                ...
                <div className="footer-inner">
                    ...
                    <div className="footer-col">
                        ...
                        <ul>
                            ...
                            <li><a href="#" onClick={e => { e.preventDefault(); setLegalDoc('terms'); }}>Правила користування</a></li>
                            <li><a href="#" onClick={e => { e.preventDefault(); setLegalDoc('offer'); }}>Договір оферти</a></li>
                            <li><a href="#" onClick={e => { e.preventDefault(); setLegalDoc('privacy'); }}>Політика конфіденційності</a></li>
                        </ul>
                    </div>
